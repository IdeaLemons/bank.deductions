...
class caccounts_view extends caccounts {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["Acc_ID"] <> "") {
			$this->RecKey["Acc_ID"] = $_GET["Acc_ID"];
			$KeyUrl .= "&amp;Acc_ID=" . urlencode($this->RecKey["Acc_ID"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["Acc_ID"] <> "") {
				...
				$this->RecKey["Acc_ID"] = $this->Acc_ID->QueryStringValue;
			} elseif (@$_POST["Acc_ID"] <> "") {
				$this->Acc_ID->setFormValue($_POST["Acc_ID"]);
				$this->RecKey["Acc_ID"] = $this->Acc_ID->FormValue;
			} else {
				$sReturnUrl = "accountslist.php"; // Return to list
			}
...
var CurrentForm = faccountsview = new ew_Form("faccountsview", "view");
...
faccountsview.Lists["x_PF"] = {"LinkField":"x_PF","Ajax":true,"AutoFill":false,"DisplayFields":["x_PF","x_Name","x_NIC",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
faccountsview.Lists["x_Bank_ID"] = {"LinkField":"x_Bank_ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Name","x_City","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php if ($accounts->Bank_ID->Visible) { // Bank_ID ?>
	<tr id="r_Bank_ID">
		<td><span id="elh_accounts_Bank_ID"><?php echo $accounts->Bank_ID->FldCaption() ?></span></td>
...
<?php echo $accounts->Bank_ID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($accounts->Acc_NO->Visible) { // Acc_NO ?>
	<tr id="r_Acc_NO">
		<td><span id="elh_accounts_Acc_NO"><?php echo $accounts->Acc_NO->FldCaption() ?></span></td>
...
<?php echo $accounts->Acc_NO->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
