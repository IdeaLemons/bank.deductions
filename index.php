...
class cdefault {
	...
	function Page_Main() {
		...
		$this->Page_Terminate("deductionslist.php"); // Exit and go to default page
		if ($Security->AllowList(CurrentProjectID() . 'accounts'))
			$this->Page_Terminate("accountslist.php");
		if ($Security->AllowList(CurrentProjectID() . 'banks'))
			$this->Page_Terminate("bankslist.php");
		if ($Security->AllowList(CurrentProjectID() . 'emp'))
			$this->Page_Terminate("emplist.php");
