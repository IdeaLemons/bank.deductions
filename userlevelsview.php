...
$userlevels_view = NULL; // Initialize page object first

class cuserlevels_view extends cuserlevels {
...
// Create page object
if (!isset($userlevels_view)) $userlevels_view = new cuserlevels_view();
...
var CurrentForm = fuserlevelsview = new ew_Form("fuserlevelsview", "view");

// Form_CustomValidate event
fuserlevelsview.Form_CustomValidate = 
...
fuserlevelsview.ValidateRequired = true;
<?php } else { ?>
fuserlevelsview.ValidateRequired = false; 
<?php } ?>
...
<?php
	foreach ($userlevels_view->OtherOptions as &$option)
		$option->Render("body");
?>
...
?>
<form name="fuserlevelsview" id="fuserlevelsview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($userlevels_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $userlevels_view->Token ?>">
<?php } ?>
