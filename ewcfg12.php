...
define("EW_PROJECT_NAME", "Bank_deductions", TRUE); // Project name
...
define("EW_RANDOM_KEY", 'Hgih767b2hKFc0BJ', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "banking", "qs" => "`", "qe" => "`");
...
define("EW_SESSION_TIMEOUT", 15, TRUE); // Session timeout time (minutes)

// Session keep alive interval
define("EW_SESSION_KEEP_ALIVE_INTERVAL", 30, TRUE); // Session keep alive interval (seconds)
...
// Security
define("EW_ADMIN_USER_NAME", "warnapura", TRUE); // Administrator user name
...
define("EW_USER_TABLE", "`emp`", TRUE);
define("EW_USER_NAME_FILTER", "(`PF` = %u)", TRUE);
...
define("EW_AUTO_FILL_ORIGINAL_VALUE", true, TRUE);
...
// Time zone
$DEFAULT_TIME_ZONE = "Asia/Colombo";
