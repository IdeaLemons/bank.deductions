...
$accounts_edit = NULL; // Initialize page object first

class caccounts_edit extends caccounts {
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->Acc_ID->CurrentValue == "")
			$this->Page_Terminate("accountslist.php"); // Invalid key, return to list
...
// Create page object
if (!isset($accounts_edit)) $accounts_edit = new caccounts_edit();

// Page init
$accounts_edit->Page_Init();

// Page main
$accounts_edit->Page_Main();
...
var CurrentForm = faccountsedit = new ew_Form("faccountsedit", "edit");
...
faccountsedit.Form_CustomValidate = 
...
faccountsedit.ValidateRequired = true;
<?php } else { ?>
faccountsedit.ValidateRequired = false; 
<?php } ?>
...
?>
<form name="faccountsedit" id="faccountsedit" class="<?php echo $accounts_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($accounts_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $accounts_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="accounts">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<div class="ewDesktop">
<div>
<table id="tbl_accountsedit" class="table table-bordered table-striped ewDesktopTable">
...
<script type="text/javascript">
faccountsedit.CreateAutoSuggest({"id":"x_PF","forceSelect":false});
</script>
</span>
...
<input type="hidden" data-table="accounts" data-field="x_Acc_ID" name="x_Acc_ID" id="x_Acc_ID" value="<?php echo ew_HtmlEncode($accounts->Acc_ID->CurrentValue) ?>">
<div class="ewDesktopButton">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $accounts_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</div>
</form>
<script type="text/javascript">
