...
class cdeductions_add extends cdeductions {
	...
	function AddRow($rsold = NULL) {
		...
		if ($this->L_Ref->CurrentValue <> "") { // Check field with unique index
			$sFilter = "(L_Ref = '" . ew_AdjustSql($this->L_Ref->CurrentValue, $this->DBID) . "')";
...
fdeductionsadd.Lists["x_PF"] = {"LinkField":"x_PF","Ajax":true,"AutoFill":false,"DisplayFields":["x_PF","x_Name","",""],"ParentFields":[],"ChildFields":["x_Acc_ID"],"FilterFields":[],"Options":[],"Template":""};
...
<script type="text/javascript">
fdeductionsadd.CreateAutoSuggest({"id":"x_PF","forceSelect":true});
</script>
</span>
