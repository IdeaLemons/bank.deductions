...
var EW_SESSION_TIMEOUT = <?php echo ew_SessionTimeoutTime() ?>; // Session timeout time (seconds)
...
<div class="ewLayout">
	...
	<div id="ewHeaderRow" class="<?php echo $gsHeaderRowClass ?>"><img src="<?php echo $EW_RELATIVE_PATH ?>phpimages/phpmkrlogo1.png" alt=""></div>
<?php if (ew_IsResponsiveLayout()) { ?>
